  ...
  <div class="container mx-auto">
    <div class="flex flex-wrap justify-center">
      <div class="w-full max-w-sm">
        <div class="flex flex-col break-words bg-white border-8 rounded-lg shadow-lg mt-20">
          ...
          <form class="py-10 px-5" method="POST" action="{{ route('password.update') }}" novalidate>
            ...
            <div class="flex flex-wrap mb-6">
              ...
              <input id="email" type="email"
                class="p-3 bg-gray-200 rounded-sm form-input w-full @error('email') border-red-500 border @enderror"
            ...
            <div class="flex flex-wrap mb-6">
              ...
              <input id="password" type="password"
                class="p-3 bg-gray-200 rounded-sm form-input w-full @error('password') border-red-500 border @enderror"
            ...
            <div class="flex flex-wrap">
              <button type="submit" class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase rounded-lg font-bold">
                {{ __('Reset Password') }}
              </button>
            </div>
          </form>
